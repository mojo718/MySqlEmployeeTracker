...
function viewAllEmployees() {
    ...
    connection.query("SELECT employees.first_name, employees.last_name, roles.title AS \"roles\", managers.first_name AS \"manager\" FROM employees LEFT JOIN roles ON employees.role_id = role.id LEFT JOIN employees managers ON employees.manager_id = managers.id GROUP BY employees.id",
      function (err, res) {
        if (err) throw err;
